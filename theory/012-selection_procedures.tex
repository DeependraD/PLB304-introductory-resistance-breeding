...
{\placefig{-0.01}{-0.01}{width=1.01\paperwidth,height=1.01\paperheight}{aplosonyx\_chrysomelidae\_20210630.jpg}
...
\textbf{Dominant gene transfer}

\begin{figure}

{\centering \includegraphics[width=0.94\linewidth]{../images/backcross_dominant} 
...
\textbf{Recessive gene transfer}

\begin{figure}

{\centering \includegraphics[width=0.98\linewidth]{../images/backcross_recessive} 
